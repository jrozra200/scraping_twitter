...
The first three steps are part of my scraping\_twitter.R script. Step 4 is my tweet\_clean.R script. Step 5:  
classify\_emotion.R. Step 6: classify\_polarity.R. Finally, step 7 comes from twitter\_analyis.R, make\_wordcloud.R, and   
make\_piechart.R scripts. 

## Step 1: Get the Tweets

The first thing I did was search Twitter for tweets that had "Comcast Email" in them. This is done through my  
scraping_twitter.R script. This step, as well as steps 2 and 3 are part of this script.
...
the best grasp on the code (as I do with the stuff I've created above).
...
and then displays the list (here I've only displayed the first 10).
